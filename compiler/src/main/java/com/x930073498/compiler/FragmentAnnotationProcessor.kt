...
class FragmentAnnotationProcessor : BaseProcessor() {
    ...
    private fun buildType(
        ...
        val fragmentDelegateType = ClassName(ComponentConstants.ROUTER_INTERFACE_PACKAGE_NAME, "FragmentActionDelegate")
    ...
    private fun buildInjectFunction(
        ...
        val inject = FunSpec.builder("inject")
            ...
            .addParameter(ParameterSpec("bundle", ClassName.bestGuess(ComponentConstants.ANDROID_BUNDLE)))
    ...
    private fun buildTargetFunction(
        ...
        val targetClassName = ClassName(ComponentConstants.ROUTER_ACTION_PACKAGE_NAME, "FragmentTarget")
    ...
    private fun buildFactoryFunction(
        ...
        val factoryClassName =
            ClassName(ComponentConstants.ROUTER_INTERFACE_PACKAGE_NAME,"FragmentActionDelegate.Factory")
                .parameterizedBy(element.asClassName())
