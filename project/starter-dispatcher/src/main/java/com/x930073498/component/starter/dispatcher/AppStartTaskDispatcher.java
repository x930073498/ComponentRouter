...
import com.x930073498.component.starter.runnable.AppStartTaskRunnable;
import com.x930073498.component.starter.task.AppStartTask;
import com.x930073498.component.starter.util.AppStartTaskLogUtils;
import com.x930073498.component.starter.util.AppStartTaskSortUtil;
import com.x930073498.component.starter.util.ProcessUtils;
...
public class AppStartTaskDispatcher {
    ...
    private void printSortTask() {
        ...
        AppStartTaskLogUtils.showLog(stringBuffer.toString());
    }
    ...
    public void markAppStartTaskFinish(AppStartTask appStartTask) {
        AppStartTaskLogUtils.showLog("任务完成了：" + appStartTask.getClass().getName());
        if (ifNeedWait(appStartTask)) {
    ...
    public void await() {
        try {
            ...
            AppStartTaskLogUtils.showLog("启动耗时：" + finishTime);
