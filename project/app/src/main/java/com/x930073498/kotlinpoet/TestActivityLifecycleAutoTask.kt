...
class TestActivityLifecycleAutoTask : IAuto, IActivityLifecycle {
    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) { println("enter this line 1401410") }
}
class TestApplicationStartAutoTask : IAuto, IApplicationLifecycle {
    override fun onApplicationCreated(app: Application) { println("enter this line 18794") }
}
class TestFragmentLifecycleAutoTask() : IAuto, IFragmentLifecycle {
    override fun onFragmentPreCreated(fm: FragmentManager, f: Fragment, savedInstanceState: Bundle?) {
        println("enter this line 1747")
    }
}